    ...
    (function( $ ) {
        ...
        PostScraper.prototype.bindSnippetCiteEvents = function( time ) {
            ...
            if ( slugElem !== null && titleElem.value !== '' ) {
                ...
                var element = document.getElementById('editable-post-name-full');
                if (typeof(element) != 'undefined' && element != null) {
                    postNameElem.value = document.getElementById('editable-post-name-full').textContent;
                    //document.getElementById('custom_permalink').textContent = document.getElementById('editable-post-name-full').textContent;
                } else {
                    postNameElem.value = document.getElementsByName('post_title')[0].value;
                }
